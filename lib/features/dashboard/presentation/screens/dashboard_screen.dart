            ...
            sliver: isLoading
                ...
                : !hasData
                    ...
                    delegate: SliverChildListDelegate([
                      ...
                      _StaggeredEntry(
                        ...
                        child: MonthlyFlowTable(
                          ...
                          onMonthTap: (ym) {
                            ...
                            ref.read(selectedYearMonthProvider.notifier).set(ym);
                          },
                        ),
                      ),
                      ...
                      // 5) Aylık Detay Dağılımı entry card
                      _StaggeredEntry(
                        delay: 400,
                        child: _MonthlyDetailEntryCard(),
                      ),
...
/// Tappable card that navigates to the monthly detail breakdown screen.
class _MonthlyDetailEntryCard extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    final c = AppColors.of(context);
    ...
    return GestureDetector(
      onTap: () {
        HapticFeedback.lightImpact();
        context.go('/dashboard/monthly-detail');
      },
      child: Container(
        padding: const EdgeInsets.symmetric(
          horizontal: AppSpacing.base,
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    'Ay bazında gelir/gider detayları ve durum takibi',
