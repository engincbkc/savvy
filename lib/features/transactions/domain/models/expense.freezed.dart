...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,amount,category,expenseType,subcategory,person,date,note,isRecurring,recurringEndDate,isDeleted,createdAt,const DeepCollectionEquality().hash(monthlyOverrides));

@override
String toString() {
  return 'Expense(id: $id, amount: $amount, category: $category, expenseType: $expenseType, subcategory: $subcategory, person: $person, date: $date, note: $note, isRecurring: $isRecurring, recurringEndDate: $recurringEndDate, isDeleted: $isDeleted, createdAt: $createdAt, monthlyOverrides: $monthlyOverrides)';
}
...
@useResult
$Res call({
 String id, double amount, ExpenseCategory category, ExpenseType expenseType, String? subcategory, String? person, DateTime date, String? note, bool isRecurring, DateTime? recurringEndDate, bool isDeleted, DateTime createdAt, Map<String, double> monthlyOverrides
});
...
switch (_that) {
case _Expense() when $default != null:
return $default(_that.id,_that.amount,_that.category,_that.expenseType,_that.subcategory,_that.person,_that.date,_that.note,_that.isRecurring,_that.recurringEndDate,_that.isDeleted,_that.createdAt,_that.monthlyOverrides);case _:
  return orElse();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,amount,category,expenseType,subcategory,person,date,note,isRecurring,recurringEndDate,isDeleted,createdAt,const DeepCollectionEquality().hash(_monthlyOverrides));
